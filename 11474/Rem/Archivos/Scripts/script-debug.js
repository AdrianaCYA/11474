...
var MVCGrid = new function () {
    ...
    this.setHandlerPath = function (path) {
        if (handlerPath == '')
            handlerPath = path + 'MVCGridHandler.axd';
    }
    ...
    // public
    this.setFiltersButton = function (mvcGridName) {
        applyBoundFilters(mvcGridName);
    }

    // public 
    this.setParamDistinct = function (mvcGridName, opt, value) {
        var o = {};
        var option = opt;
        o[option] = value;
        MVCGrid.setFilters(mvcGridName, o);          
